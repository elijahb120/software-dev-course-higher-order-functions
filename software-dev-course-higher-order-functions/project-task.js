...
console.log("Items in Stock: ", isInStock);
...
const discountedProducts = products.map((product) => ({...product, price: discount10(product.price)}
  ));
...
*/
function stockedInventory(products) {
  return products.filter((product) => product.inStock);
  
}
let itemsInStock = stockedInventory(products);
let totalValueOfInventory = itemsInStock.reduce((accumulator, currentValue) => accumulator + currentValue.price, 0);
console.log("In Stock: " , itemsInStock, "Total Value in Stock: " , totalValueOfInventory);
// ============================================
